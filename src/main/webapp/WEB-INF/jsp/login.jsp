...
<div class="center">
<div class="message">
<form method="post" action="<%=basePath%>user/login" id="commentForm">
    <fieldset>
        <div class="person-information">
            ...
            <div class="right-box">
                ...
                <div>邮箱 (必填) &nbsp; &nbsp;<input type="email" width="100%" placeholder="邮箱" name="userEmail" id="commentsEmail" required/></div>
            </div>
            <div class="clear"></div>
